...
export function AboutSection({
  ...
  return (
    ...
    >
      <ScrollReveal className="md:sticky md:top-8" direction="start">
        <img
          src={images.portrait}
          alt=""
          loading="lazy"
          decoding="async"
          className="h-80 w-full rounded-[1.65rem] object-cover object-top grayscale md:h-[32rem]"
        />
      </ScrollReveal>
      <ScrollReveal direction="end" delay={120}>
