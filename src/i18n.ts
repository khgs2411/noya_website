  ...
  en: {
    translation: {
      ...
      auth: {
        ...
        signupBody: 'Create your account for this product.',
        signinTab: 'Sign in',
        signupTab: 'Sign up',
        email: 'Email',
        password: 'Password',
        ...
        signinUnavailable: 'Sign-in is not enabled for this product yet.',
        signupUnavailable: 'Sign-up is not enabled for this product yet.',
      },
      profile: {
        title: 'Profile',
        body: 'Your account state and product access are managed by ClassKit.',
        ...
        inviteRequired: 'This account is signed in, but it has not been invited to this product yet.',
        refresh: 'Refresh',
        managerPending: 'Manager workspace access is enabled. The workspace will be implemented in the next roadmap step.',
        statuses: { active: 'Active', inactive: 'Inactive' },
        roles: { manager: 'Manager', user: 'User' },
        capabilities: {
          title: 'Capabilities',
          none: 'No manager capabilities are enabled for this account.',
          dashboard: 'Enter manager dashboard',
          classes: 'Manage classes',
          roles: 'Manage roles',
          users: 'Manage users',
          authMode: 'Manage auth mode',
        },
      },
      hero: {
  ...
  ru: {
    translation: {
      ...
      auth: {
        ...
        signupBody: 'Создайте аккаунт для этого продукта.',
        signinTab: 'Вход',
        ...
        signinUnavailable: 'Вход для этого продукта пока не включен.',
        signupUnavailable: 'Регистрация для этого продукта пока не включена.',
      },
      profile: {
        title: 'Профиль',
        body: 'Состояние аккаунта и доступ к продукту управляются ClassKit.',
        ...
        inviteRequired: 'Аккаунт вошел в систему, но еще не приглашен в этот продукт.',
        refresh: 'Обновить',
        managerPending: 'Доступ к рабочей области менеджера включен. Она будет реализована на следующем этапе.',
        statuses: { active: 'Активен', inactive: 'Неактивен' },
        roles: { manager: 'Менеджер', user: 'Пользователь' },
        capabilities: {
          title: 'Возможности',
          none: 'Для этого аккаунта не включены возможности менеджера.',
          dashboard: 'Вход в панель менеджера',
          classes: 'Управление занятиями',
          roles: 'Управление ролями',
          users: 'Управление пользователями',
          authMode: 'Управление режимом входа',
        },
      },
      hero: {
        eyebrow: 'Body * Dance * Movement',
  ...
  he: {
    translation: {
      ...
      auth: {
        ...
        signupBody: 'צרי חשבון עבור המוצר הזה.',
        signinTab: 'התחברות',
        signupTab: 'הרשמה',
        email: 'אימייל',
        password: 'סיסמה',
        ...
        signinUnavailable: 'התחברות עדיין לא מופעלת עבור המוצר הזה.',
        signupUnavailable: 'הרשמה עדיין לא מופעלת עבור המוצר הזה.',
      },
      profile: {
        title: 'פרופיל',
        body: 'מצב החשבון והגישה למוצר מנוהלים דרך ClassKit.',
        ...
        inviteRequired: 'החשבון מחובר, אבל עדיין לא הוזמן למוצר הזה.',
        refresh: 'רענון',
        managerPending: 'גישת ניהול מופעלת. סביבת הניהול תיושם בשלב הבא במפת הדרך.',
        statuses: { active: 'פעיל', inactive: 'לא פעיל' },
        roles: { manager: 'מנהלת', user: 'משתמשת' },
        capabilities: {
          title: 'יכולות',
          none: 'לא הופעלו יכולות ניהול עבור החשבון הזה.',
          dashboard: 'כניסה ללוח הניהול',
          classes: 'ניהול שיעורים',
          roles: 'ניהול תפקידים',
          users: 'ניהול משתמשים',
          authMode: 'ניהול מצב התחברות',
        },
      },
      hero: {
        eyebrow: 'Body * Dance * Movement',
