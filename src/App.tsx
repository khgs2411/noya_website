          ...
          <div className="relative">
            <p className="mt-6 max-w-2xl whitespace-pre-line text-base leading-7 text-foreground/72">
              <span className="md:hidden">
                {aboutExpanded ? t("about.body") : t("about.mobilePreview")}
              </span>
          ...
          >
            ...
            <div className="mt-3.5 grid grid-cols-2 gap-2.5">
                <Button
                  ...
                  variant="ghost"
                  size="icon"
                  className="h-10 w-full rounded-xl border border-blush/25 bg-background/58 text-foreground shadow-sm hover:bg-blush/22 [&_svg]:!size-4"
                  aria-label={t("theme.toggle")}
                  onClick={toggleTheme}
                >
                  {theme === "dark" ? <Moon /> : <Sun />}
                ...
                <LanguageMenu
                  buttonClassName="h-10 w-full rounded-xl border border-blush/25 bg-background/58 shadow-sm hover:bg-blush/22 [&_svg]:!size-4"
