...
>
> Do not execute this chunk. It assumes permanent GitHub Pages production and
> a separately uploaded staging project. See the addenda at the top of
> `../spec.md` and `../plan.md`; replacement chunks must be written and
> approved first.
